...
alphaMapLoader.load('http://jsrun.it/assets/m/v/Q/2/mvQ20.png', function (alphaMapTexture) {

    // load texture
    var textureLoader = new THREE.TextureLoader();
    textureLoader.load('http://jsrun.it/assets/K/Q/q/c/KQqcE.jpg', function (sprite) {
        texture = sprite;
