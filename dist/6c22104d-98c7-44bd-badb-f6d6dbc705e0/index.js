...
alphaMapLoader.load('http://jsrun.it/assets/Q/e/9/p/Qe9pW.png', function (alphaMapTexture) {

    // load texture
    var textureLoader = new THREE.TextureLoader();
    textureLoader.load('http://jsrun.it/assets/8/P/z/S/8PzSJ.jpg', function (texture) {
