...
(function($, win, doc) {
    ...
    Main.prototype.draw = function() {
        ...
        camera.zoom = 0.7 + 0.3*Math.cos(diffTime*4*0.1*Math.PI/180);
        ...
        this.cubeSize.x = 80 + 30*Math.sin(diffTime*0.1*Math.PI/180);
        this.cubeSize.y = 80 + 30*Math.sin(diffTime*0.1*Math.PI/180);
        this.cubeSize.z = 80 + 30*Math.sin(diffTime*0.1*Math.PI/180);
