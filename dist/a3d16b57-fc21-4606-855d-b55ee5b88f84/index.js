...
var Ball = (function (_createjs$Shape) {
    ...
    function Ball(opts) {
        ...
        this.drawX = opts.x || Math.floor(Math.random() * window.innerWidth);
        this.drawY = opts.y || Math.floor(Math.random() * window.innerHeight);
        this.x = 0;
        this.y = 0;
        this.initialize();
    }
    ...
    _createClass(Ball, [{
        ...
        value: function initialize() {
            ...
            this.graphics.drawCircle(this.drawX, this.drawY, this.radius);
...
var Main = (function () {
    ...
    _createClass(Main, [{
        ...
        value: function initObjects() {
            this.ball = new Ball({ x: WIDTH / 2, y: HEIGHT / 2, radius: 150 });
        ...
        value: function update(event) {
            ...
            this.ball.alpha = 0.5;
            if (this.ball.hitTest(this.stage.mouseX, this.stage.mouseY)) {
                this.ball.alpha = 1;
            }
