...
var Main = (function () {
    ...
    _createClass(Main, [{
        ...
        value: function initialize() {
            ...
            this.renderer = new PIXI.WebGLRenderer(WIDTH, HEIGHT, { backgroundColor: 0xFFFFFF });
            ...
            this.stage.filters = [this.twistFilter, this.blurFilter];
        ...
        value: function update() {
            ...
            this.twistFilter.radius = Math.sin(diff * Math.PI / 180 / 6);
