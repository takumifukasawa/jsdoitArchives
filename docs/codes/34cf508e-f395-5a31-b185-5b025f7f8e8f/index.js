...
alphaMapLoader.load('/common/img/f9c22c58.png', function (alphaMapTexture) {

    // load texture
    var textureLoader = new THREE.TextureLoader();
    textureLoader.load('/common/img/photo-1474470172489-c75ce5cbf836.jpeg', function (sprite) {
        texture = sprite;
