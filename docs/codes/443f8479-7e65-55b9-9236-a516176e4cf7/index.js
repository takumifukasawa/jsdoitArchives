...
bgImage.src = '/jsdoitArchives/assets/img/photo-1433208406127-d9e1a0a1f1aa.jpeg';

var texImage = new Image();
texImage.onload = function () {
    start();
};
texImage.src = '/jsdoitArchives/assets/img/photo-1466220666686-90bdba318c9a.png';
