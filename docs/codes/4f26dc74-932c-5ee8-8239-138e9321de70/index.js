// forked from takumifukasawa's "threejs: textureにcanvasを指定してsprite animation: 負荷テスト" http://jsdo.it/takumifukasawa/albn
...
var Sprite = (function () {
    function Sprite(texture, row, col) {
        _classCallCheck(this, Sprite);

        this.texture = texture;

        // change sprite position
        this.spriteWidth = texture.image.width;
        this.spriteHeight = texture.image.height;
        this.col = col;
        this.row = row;
...
for (var i = 0; i < TILE_NUM; i++) {
    ...
    textureLoader.load('/jsdoitArchives/assets/img/photo-1439546743462-802cabef8e97.jpeg?+Date.now()', function (texture) {

        texture.needsUpdate = true;

        var plane = new Sprite(texture, 8, 8);
