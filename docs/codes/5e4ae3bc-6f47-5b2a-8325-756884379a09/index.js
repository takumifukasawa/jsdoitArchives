// forked from takumifukasawa's "forked: webgl: threejsでglslを書く雛形" http://jsdo.it/takumifukasawa/iAxU
...
textureLoader.load("/jsdoitArchives/assets/img/MIbCzcvxQdahamZSNQ26_12082014-IMG_3526.png", function (tex) {
    console.log(tex);
    init(tex);
});
