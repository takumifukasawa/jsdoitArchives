// forked from takumifukasawa's "[2015.8.15] canvasとスクロールを連動" http://jsdo.it/takumifukasawa/5BXA
(function($, window, document, undefined) {
    ...
    Circle.prototype.update = function(ctx) {
        ...
        this.moveX *= this.bound;
        this.moveY *= this.bound;        
