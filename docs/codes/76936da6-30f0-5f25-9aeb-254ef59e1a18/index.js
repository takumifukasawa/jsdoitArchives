...
var img = new Image();
img.src = "/jsdoitArchives/assets/img/photo-1471851455650-fae7acd5364f.jpeg";

// キャッシュを強制的に使わせない -> onloadが必ず呼ばれる
//img.src = "/jsdoitArchives/assets/img/photo-1451479456262-b94f205059be.jpg" + "?" + new Date().getTime();
