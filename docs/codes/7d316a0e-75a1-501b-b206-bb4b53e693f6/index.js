...
(function($, win, doc) {
    ...
    Main.prototype.update = function() {
        ...
        */
        ...
        var diffTime = (this.nowTime-this.beginTime)/750;
        ...
        for(var s=0, slen=this.lineObjects; s<slen; s++) {        
            for(var i=0, len=this.lines.length; i<len; i++) {
                ...
                this.lines[i].rotation.y += 0.004;
                this.lines[i].rotation.z += 0.002;
            }
            var scale = 0.1 + Math.pow(Math.sin(diffTime - 1000*s), 2)*0.3;
