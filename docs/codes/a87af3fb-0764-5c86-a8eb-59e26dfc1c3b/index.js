...
alphaMapLoader.load('/jsdoitArchives/assets/img/photo-1463780324318-d1a8ddc05a11.png', function (alphaMapTexture) {

    // load texture
    var textureLoader = new THREE.TextureLoader();
    textureLoader.load('/jsdoitArchives/assets/img/photo-1464013778555-8e723c2f01f8.jpg', function (sprite) {
        texture = sprite;
