...
alphaMapTextureLoader.load('/jsdoitArchives/assets/img/photo-1482160549825-59d1b23cb208.png', function (texture) {
    var alphaMap = texture;

    // load texture
    var textureLoader = new THREE.TextureLoader();
    textureLoader.load('/jsdoitArchives/assets/img/photo-1425036458755-dc303a604201.jpeg', function (texture) {
        sprite = texture;
