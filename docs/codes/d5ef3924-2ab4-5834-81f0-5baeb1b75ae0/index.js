...
(function ($, win, doc) {
    ...
    var Circle = (function () {
        function Circle(opts) {
            ...
            this.distance = opts.distance || 150;
            this.timer = 0;
        }
        ...
        _createClass(Circle, [{
            ...
            value: function update(num) {
                ...
                if (this.goalRadius <= this.baseRadius) this.goalRadius = this.baseRadius;

                this.r += (this.goalRadius - this.r) / 5;
                this.alpha += (this.goalAlpha - this.alpha) / 10;

                this.timer++;
                var baseTime = this.timer / 10;
                this.x = this.baseX + this.distance * Math.sin(baseTime * 180 / Math.PI) * Math.cos(this.degree * 180 / Math.PI);
                this.y = this.baseY + this.distance * Math.sin(baseTime * 180 / Math.PI) * Math.sin(this.degree * 180 / Math.PI);
    ...
    var Main = (function () {
        ...
        _createClass(Main, [{
            ...
            value: function initialize() {
                ...
                var baseDeg = 360 / this.circlesNum;
