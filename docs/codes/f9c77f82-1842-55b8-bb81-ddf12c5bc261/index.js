// forked from takumifukasawa's "[2015.10.11] three.jsで雪を降らす" http://jsdo.it/takumifukasawa/4IJw
...
(function($, win, doc) {
    ...
    Main.prototype.initialize = function() {
        ...
        this.controlls = new THREE.OrbitControls(this.camera, this.renderer.domElement);
    ...
    Main.prototype.makeMaterial = function() {         
        this.texture = THREE.ImageUtils.loadTexture("/jsdoitArchives/assets/img/photo-1465935343323-d742334bcbda.png");
