// forked from takumifukasawa's "[2015.9.25] 透明度の限界は0.01" http://jsdo.it/takumifukasawa/q0Wm
// forked from takumifukasawa's "[2015.9.22] 動き回る三角形" http://jsdo.it/takumifukasawa/83lA
(function(window, document, undefined) {
    ...
    Main.prototype.updateShapeBg = function(points) {
        this.bg.graphics.beginFill("rgba(255,150,100,0.04)");
        this.bg.graphics
