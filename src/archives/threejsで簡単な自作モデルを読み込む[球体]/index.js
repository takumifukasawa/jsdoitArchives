// forked from takumifukasawa's "threejsで簡単な自作モデルを読み込む" http://jsdo.it/takumifukasawa/WFMl
        ...
        value: function loadObj() {
            ...
            function loadMaterial() {
                return new Promise(function (resolve, reject) {
                    mtlLoader.load('http://jsrun.it/assets/e/0/q/i/e0qi4', function (materials) {
                        materials.preload();
                        resolve(materials);
                    });
                });
            ...
            function loadObject(materials) {
                return new Promise(function (resolve, reject) {
                    ...
                    objLoader.load('http://jsrun.it/assets/E/i/T/q/EiTq0', function (object) {
                        var mesh = object;
                        resolve(mesh);
                    });
                });
