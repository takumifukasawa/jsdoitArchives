...
// test lines
var lines = new THREE.Mesh(getMusicScoreGeometry(0, 60, 240, 200, 0, 0, 0), material);
//scene.add(lines);

// spiral
var spiralGeometry = getSpiralGeometry(2, 200, 600, 15, 8, 20);
...
function getSpiralGeometry(pointsNum, linesNum, radius, deltaAngle, deltaHeight, thickness) {
    ...
    var lineMesh = new THREE.Line(lineGeometry, new THREE.MeshBasicMaterial({ color: 0xff0000 }));
    //scene.add(lineMesh);
